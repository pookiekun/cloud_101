-- Hunt Game Mode Database Schema
-- This extends the existing CLOUD 101 schema with Hunt Game tables
...
CREATE INDEX idx_hunt_players_session ON hunt_players(session_id);
CREATE INDEX idx_hunt_cards_session_player ON hunt_cards(session_id, player_id);
CREATE INDEX idx_hunt_board_session ON hunt_board(session_id);
CREATE INDEX idx_hunt_questions_session ON hunt_questions(session_id);
